...
urlpatterns = [
    ...
    path('Productdisplay/', products_views.display_products, name='display'),

    path('add/', products_views.add_product, name='add_product'),

    path('products/<int:pk>/edit/', products_views.edit_product, name='edit_product'),
